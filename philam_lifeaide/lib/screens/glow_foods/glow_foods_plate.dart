...
var bread = Image.asset('assets/images/rice.png');

var cereals = Image.asset('assets/images/rice.png');

var pasta = Image.asset('assets/images/rice.png');
...
class GlowFoodsPlate extends StatelessWidget {
  const GlowFoodsPlate({Key key}) : super(key: key);
                ...
                slivers: <Widget>[
                  ...
                  SliverPadding(
                    ...
                    sliver: SliverGrid.count(
                      ...
                      crossAxisSpacing: 10,
                      children: <Widget>[
                        InkWell(child: cards(rice, 'Corn', '86'), onTap: () {}),
                        cards(bread, 'Apple', '52'),
                        cards(cereals, 'Broccoli', '34'),
                        cards(pasta, 'Potatoes', '77'),
                      ],
                    ),
                  ),
                ],
